...
public class Fight {
    ...
    public void simulateFight(){
        ...
        if(hero.isAlive())System.out.printf("%s was defeated.\n",orc.getName());
        else System.out.printf("%s was defeated.\n",hero.getName());
    }
